...
|2|Руководитель партнерского колл-центра, Оператор бэк-офиса депозитов|Актуализация данных|1.Оператор бэк-офиса отправляет актуальный XLS-файл по защищенному каналу на SFTP-папку колл-центра||
||||2.Руководитель колл-центра доводит информацию до сотрудников|
